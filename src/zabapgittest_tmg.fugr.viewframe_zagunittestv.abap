...
*----------------------------------------------------------------------*
CALL FUNCTION 'VIEWPROC_ZAGUNITTESTV'
         EXPORTING
              FCODE          = READ
...
EXTRACT = ZAGUNITTESTV_EXTRACT
TOTAL = ZAGUNITTESTV_TOTAL
              X_HEADER       = X_HEADER
              X_NAMTAB       = X_NAMTAB
...
CALL FUNCTION 'VIEWPROC_ZAGUNITTESTV'
             ...
             IMPORTING
                  UCOMM           = FUNCTION
UPDATE_REQUIRED = STATUS_ZAGUNITTESTV-UPD_FLAG
             TABLES
                  EXCL_CUA_FUNCT  = EXCL_CUA_FUNCT
EXTRACT = ZAGUNITTESTV_EXTRACT
TOTAL = ZAGUNITTESTV_TOTAL
...
*----------------------------------------------------------------------*
      ...
      IF ( FUNCTION EQ SWITCH_TO_SHOW_MODE OR
           ...
           FUNCTION EQ END ) AND
STATUS_ZAGUNITTESTV-UPD_FLAG NE SPACE.
        PERFORM BEENDEN.
        CASE SY-SUBRC.
          WHEN 0.
CALL FUNCTION 'VIEWPROC_ZAGUNITTESTV'
...
TOTAL = ZAGUNITTESTV_TOTAL
            ...
            CASE SY-SUBRC.
              WHEN 0.
IF STATUS_ZAGUNITTESTV-UPD_FLAG EQ SPACE. EXIT. ENDIF.
...
IF STATUS_ZAGUNITTESTV-UPD_FLAG NE SPACE.
